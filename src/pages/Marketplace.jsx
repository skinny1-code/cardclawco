          ...
          <div style={{ background:'#0f1218',border:'1px solid rgba(255,255,255,0.08)',borderRadius:18,padding:'28px 24px',maxWidth:340,width:'100%' }}>
            ...
            {listPrice && parseFloat(listPrice) > 0 && (
              <div style={{ marginBottom:14 }}>
                <div style={{ display:'flex',justifyContent:'space-between',padding:'8px 12px',background:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.06)',borderRadius:8 }}>
                  <span style={{ fontFamily:"'DM Mono',monospace",fontSize:9,color:'rgba(240,237,230,0.3)',letterSpacing:1 }}>LISTING PRICE</span>
